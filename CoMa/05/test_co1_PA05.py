...
def test_optimal_line():
    ...
    assert a == pytest.approx(-0.5419847328244275)
    assert b == pytest.approx(2.198473282442748)
...
def test_distance_to_optimal_line():
    ...
    assert distance == pytest.approx(5.129770992366414)
...
def test_distance_to_opt():
    ...
    assert distance == pytest.approx(10.870229007633586)
